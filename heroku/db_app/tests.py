...
#        boolean = (common == ET.fromstring("<Common><ExternalLinks><li href=\"http://www.katrina.noaa.gov/images/katrina-08-28-2005.jpg\">Katrina NOAA.gov</li><li href=\"http://www.mthurricane.com/Hurricane_Katrina/Hurricane_Katrina_Index_02.jpg\">View of the Hurricane in action</li></ExternalLinks></Common>"))
#        print(boolean)
#        print(ET.dump(common))
#        print("<Common><ExternalLinks><li href=\"http://www.katrina.noaa.gov/images/katrina-08-28-2005.jpg\">Katrina NOAA.gov</li><li href=\"http://www.mthurricane.com/Hurricane_Katrina/Hurricane_Katrina_Index_02.jpg\">View of the Hurricane in action</li></ExternalLinks></Common>")
...
#        self.assert_(boolean)
    ...
    def test_eval_common_1(self):
        ...
        #print(ET.tostring(main_)) # Let's see our result (for debugging purposes)
    ...
    def test_eval_organizations_1(self):
        ...
        for o in root :
            assert(root != None)
            assert(False)
            print "child.tag: ", o.tag,"child.attribute",o.attribute
        print
    ...
    # Test an empty export_xml_solve set
